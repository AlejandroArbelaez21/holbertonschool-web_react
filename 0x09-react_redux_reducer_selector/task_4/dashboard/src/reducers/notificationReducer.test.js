...
describe("courseReducer tests", function () {
  test("Tests that the default state returns an initial state", () => {
    const state = notificationReducer(undefined, {});

    expect(state).toEqual(Map(initialNotificationState));
  });
  test("Tests that FETCH_NOTIFICATIONS_SUCCESS returns the data passed", () => {
    const action = {
  ...
  test("Tests that MARK_AS_READ returns the data with the right item updated", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
  ...
  test("Tests that SET_TYPE_FILTER returns the data with the right item updated", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
