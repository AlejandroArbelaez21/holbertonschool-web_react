...
describe("Selectors tests", function () {
  test("test that filterTypeSelected works as expected", () => {
  ...
  test("test that getNotifications returns a list of the message entities within the reducer", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
  ...
  test("test that getUnreadNotifications return a list of the message entities within the reducer", () => {
    const initialState = {
      filter: "DEFAULT",
      notifications: [
        {
