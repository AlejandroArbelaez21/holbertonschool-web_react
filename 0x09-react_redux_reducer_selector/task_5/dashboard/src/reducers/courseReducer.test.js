...
describe("courseReducer tests", function () {
  ...
  test("Tests that FETCH_COURSE_SUCCESS returns the data passed", () => {
    const action = {
  ...
  test("Tests that SELECT_COURSE returns the data with the right item updated", () => {
    const initialState = [
      {
        id: 1,
        name: "ES6",
  ...
  test("Tests that UNSELECT_COURSE returns the data with the right item updated", () => {
    const initialState = [
      {
        id: 1,
        name: "ES6",
